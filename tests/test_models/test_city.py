#!/usr/bin/python3
"""
Contains Test city docs classes
"""
...
class TestCityDocs(unittest.TestCase):
    """documentation and style of City class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_test_city(self):
        """ test test_city.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Test City has attribute name and empty string"""
        city = City()
    ...
    def test_state_id_attr(self):
        """Test city has attribute state_id and empty string"""
        city = City()
