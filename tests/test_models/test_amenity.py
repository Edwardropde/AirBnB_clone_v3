...
class TestAmenityDocs(unittest.TestCase):
    """Test checking documentation and style of Amenity class"""
    @classmethod
    def setUpClass(cls):
        """doc test set up"""
    ...
    def test_pep8_conformance_amenity(self):
        """test chacking amenity.py/models conforms to PEP 8"""
    ...
    def test_pep8_conformance_test_amenity(self):
        """test for if test_amenity.py conforms to PEP8"""
        pep8s = pep8.StyleGuide(quiet=True)
