...
class TestReviewDocs(unittest.TestCase):
    """Test to check documentation and style"""
    @classmethod
    def setUpClass(cls):
        """Doc test set up"""
    ...
    def test_pep8_conformance_review(self):
        """Test review.py adheres to PEP8"""
    ...
    def test_pep8_conformance_test_review(self):
        """Test that checks if test_review.py adheres to PEP8"""
        pep8s = pep8.StyleGuide(quiet=True)
...
class TestReview(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """TEst if it is a subclass of BaseModel"""
        review = Review()
    ...
    def test_place_id_attr(self):
        """Test review has attribute place_id and empty string"""
        review = Review()
    ...
    def test_user_id_attr(self):
        """Test review has attribute user_id and is an empty string"""
        review = Review()
    ...
    def test_text_attr(self):
        """Test review has attribute text and is an empty string"""
        review = Review()
    ...
    def test_to_dict_creates_dict(self):
        """
        Test to_dict method if it creates dictionary with appropriate
        attributes
        """
        r = Review()
        new_d = r.to_dict()
    ...
    def test_to_dict_values(self):
        """Test values in dict returned from to_dict are accurate"""
    ...
    def test_str(self):
        """Test if str method has accurate output"""
        review = Review()
